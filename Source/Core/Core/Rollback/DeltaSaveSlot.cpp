...
// "nt" = Non Temporal. Bypasses cpu cache and goes into a write-combine buffer which is ideal for
// large memcpys like savestates i found 1 level of loop unrolling like this was best at least for
// my cpu
...
// memcpy but uses faster wide non-temporal stores, and skips subranges that are in our exclusion
// list
